...
- GPA: **3.74 / 4.0**
- 主修课程：计算机视觉、人工智能前沿技术、计算机网络、操作系统、软件工程、软件质量保障与测试、数据库系统、面向对象程序设计
...
- **结果：** 在中国联通真实场景任务上，相较多种基线方案取得更优完成率、跳步率与有效引导率，完成率达到 **64.68**。
...
- **系统指标：** 通信成功率达到 **98.5%**，较传统方案通信效率提升约 **40%**。
...
# 🧑‍💼 学生工作与服务
- 武汉大学学生党支部书记联席会新闻宣传部副部长（2024.09 - 2025.09）：参与本科生党建宣传工作，协助稿件组织、内容统筹与发布流程优化，累计参与发布稿件 **100+** 篇。
- 武汉大学校团委第二课堂中心项目组成员（2023.10 - 2024.09）：参与平台质量监控与问题排查，协助推动多项平台问题修复与体验改进。
